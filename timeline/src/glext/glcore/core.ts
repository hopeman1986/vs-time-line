...
module webglext {
    ...
    export class Pane {
        ...
        updatePrefSizes( result : Size ) {
            ...
            // This pane
            if ( isNotEmpty( this._layout ) && isNotEmpty( this._layout.updatePrefSize ) ) {
        ...
        updateBounds( viewport : BoundsUnmodifiable, scissor : BoundsUnmodifiable ) {
            ...
            // Child panes
            if ( isNotEmpty( this._layout ) && isNotEmpty( this._layout.updateChildViewports ) ) {
    ...
    function mouseWheelSteps( ev : WheelEvent ) : number { ///MouseWheelEvent
    ...
    function attachEventListeners( element : HTMLElement, contentPane : Pane ) {
        ...
        function refreshMouseCursor( ) {
            ...
            for ( var n = 0; n < currentPanes.length; n++ ) {
                ...
                if ( isNotEmpty( newMouseCursor ) ) break;
            }
            if ( !isNotEmpty( newMouseCursor ) ) {
        ...
        var handleMouseWheel = function( ev : WheelEvent) { //MouseWheelEvent //B2PB2P
            var i = iMouse( element, ev );
            var j = jMouse( element, ev );
    ...
    export function newDrawable( canvas : HTMLCanvasElement ) : Drawable {
        ...
        return {
            ...
            redraw: function( ) {
                if ( !isNotEmpty( pendingRequestId ) ) {
