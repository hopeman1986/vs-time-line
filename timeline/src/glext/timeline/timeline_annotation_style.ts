module webglext {
    ...
    export class TimelineAnnotationStyleUi {
        ...
        private _setAttrs( style : TimelineAnnotationStyle ) {
            this._color = isNotEmpty( style.color ) ? parseCssColor( style.color ) : undefined;
            ...
            this._icons = isNotEmpty( style.color ) ? style.icons.map( ( icon )=>{ return new TimelineAnnotationIconUi( icon ); } ) : [];
        }
